...
func (*User) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case user.FieldID, user.FieldUsername, user.FieldEmail, user.FieldPassword, user.FieldAvatar, user.FieldEmployeeID:
